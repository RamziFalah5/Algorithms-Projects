...
public class ControlSystem {
	...
	public BorderPane mainInterFace() {
		...
		ImageView KnapSackImage = new ImageView(
				new Image(getClass().getResource("/application/KnapSack.png").toExternalForm()));

		Button b1 = new Button("Tasks");
		VBox.setMargin(b1, new Insets(70, 10, 0, 10));
		style(b1);
		ImageView taskIamge = new ImageView(
				new Image(getClass().getResource("/application/Task.png").toExternalForm()));
		...
		style(b2);
		ImageView ScheduleImage = new ImageView(
				new Image(getClass().getResource("/application/Schedule.png").toExternalForm()));
		...
		style(b3);
		ImageView ScheduleImage2 = new ImageView(
				new Image(getClass().getResource("/application/Greedy.png").toExternalForm()));
		...
		ImageView reportImage = new ImageView(
				new Image(getClass().getResource("/application/Report.png").toExternalForm()));
		...
		ImageView settingImage = new ImageView(
				new Image(getClass().getResource("/application/Setting.png").toExternalForm()));
		...
		ImageView exitImage = new ImageView(
				new Image(getClass().getResource("/application/Exit.png").toExternalForm()));
